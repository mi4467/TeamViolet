...
public class NotificationHelperTest {
    ...
    @Before
    public void setup() {
        instrumentationCtx = InstrumentationRegistry.getInstrumentation().getTargetContext();
    ...
    public void addDigestNotifTest(){
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(InstrumentationRegistry.getInstrumentation().getTargetContext(), -4, intent, PendingIntent.FLAG_UPDATE_CURRENT);
